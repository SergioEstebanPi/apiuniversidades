...
class CaractersControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create caracter" do
    assert_difference('Caracter.count') do
      post caracters_url, params: { caracter: { carater_institucion: @caracter.carater_institucion } }, as: :json
    end
  ...
  test "should update caracter" do
    patch caracter_url(@caracter), params: { caracter: { carater_institucion: @caracter.carater_institucion } }, as: :json
    assert_response 200
  end
